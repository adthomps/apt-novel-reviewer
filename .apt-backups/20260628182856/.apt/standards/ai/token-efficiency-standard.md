...
APT Agent or `apt-agent-standards` owns concrete context-pack directories, token-budget tooling, and prompt-loading behavior. `apt-principles` defines sufficient-context standards, reuse expectations, and review evidence.
