...
APT Agent or `apt-agent-standards` owns verification runners, report files, and command adapters. `apt-principles` defines verification levels, evidence types, failure conditions, and approval expectations.
