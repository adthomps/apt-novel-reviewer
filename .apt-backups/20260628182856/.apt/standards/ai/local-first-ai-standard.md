...
APT Agent or `apt-agent-standards` owns local model discovery, local tool inventories, and external-call audit implementation. `apt-principles` defines the local-first posture, data boundary rules, and escalation principles.
