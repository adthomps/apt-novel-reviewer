...
The implementation should support security and non-security governance checks without making `apt-principles` an implementation repository.

## Implementation Boundary

APT Agent or `apt-agent-standards` owns scanners, detectors, repair flows, sensitive-data guards, and generated reports. `apt-principles` defines the security harness pattern, controls, approval gates, and failure conditions.
